...
before(async () => {
  ...
  await productsCollection.insertOne({
    _id: new ObjectId("60a6f6f6f6f6f6f6f6f6f6f6"),
  ...
  it('should add the correct quantity to the cart', function(done) {
    ...
    agent
      ...
      .end((err, res) => {
        ...
        agent
          .post('/addToCart')
          .send({ productId: '60a6f6f6f6f6f6f6f6f6f6f6', quantity: '2' })
          .end((err, res) => {
            if (err) return done(err);
            expect(res.status).to.equal(302);
            ...
            agent
              ...
              .end((err, res) => {
                ...
                expect(cart['60a6f6f6f6f6f6f6f6f6f6']).to.equal(2);
                done();
              });
          });
      });
  ...
  it('should remove product with 0 stock from the cart', function(done) {
    ...
    agent
      ...
      .end((err, res) => {
        ...
        agent
          .post('/addToCart')
          .send({ productId: '60a6f6f6f6f6f6f6f6f6f6', quantity: '3' })
          .end((err, res) => {
            if (err) return done(err);
            expect(res.status).to.equal(302);
            ...
            agent
              ...
              .end((err, res) => {
                ...
                expect(cart['60a6f6f6f6f6f6f6f6f6f6']).to.equal(3);
